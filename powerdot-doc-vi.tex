...
\IfFileExists{/home/users/kyanh/.kyanh.}{}{
\typeout{***********************************}
...
\makeatletter
\let\old@DeclareOption=\DeclareOption
\makeatother
...
\author{Hendri Adriaens\and Christopher Ellison
	\\\and \underline{Biên dịch:} kyanh <\url{mailto:kyanh@o2.pl}>}
...
Giá trị mặc định là |\arabic{slide}~/~\pageref*{lastslide}|, mà với nó,
các |slide| sẽ đánh số tương tự như |5/22| (slide 5, tổng số slide 22).
...
Giá trị mặc định là |note~\arabic{note}~of~slide~\arabic{slide}|,
...
hiệu ứng mặc định cho trình diễn là |Wipe|; ngoải ra,
...
%% given by |type=0|.
Bây giờ, mọi phần tử đều được thể hiện với \emph{màu nhạt}\index{màu nhạt}
...
Tham số bổ sung \meta{overlays} này danh sách các |overlay|
mà phần tử của danh sách sẽ xuất hiện (có nghĩa, một phần tử
có thể xuất hiện ở một hay nhiều |overlay| khác nhau). Trong
...
màu của nó được tô nhạt. Ta có thể minh họa như sau (dấu |*| chỉ màu nhạt):
\begin{example}
--A---- 
--*B--- 
--**C--
...
tham số bổ sung chỉ định |overlay|, thì tại mỗi thời điểm chỉ có một
và chỉ một phần tử xuất hiện, các phần tử khác không phải xuất hiện với
màu nhạt, mà \emph{không xuất hiện}:
\begin{example}
--A---- 
---B--- 
----C--
