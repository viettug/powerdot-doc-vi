...
hoặc bên dưới (|portrait|). Đòi hỏi các gói \pf{pst-grad} \cite{PSTrickWeb,PSTricks}.
\item\pf{ciment}\\
...
%% that and do
Mã nguồn của lớp \pf{powerdot} là tập tin |powerdot.dtx|. Bạn có thể
biên dịch mã nguồn này theo các bước sau:
\begin{example}
 latex powerdot.dtx
 latex powerdot.dtx
 bibtex powerdot
