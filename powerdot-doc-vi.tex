...
Có nhiều phần được thêm vào, một số phần khác được lượt bớt.
Riêng Mục~\vref{sec:styles} chưa được dịch vì chưa cần thiết lắm
...
đây. Bạn có thể tải về bản đầy đủ của tài liệu ở \url{http://download.viettug.org/}.
\begin{description}
\item[img/]
