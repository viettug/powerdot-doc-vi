...
\IfFileExists{/home/users/kyanh/.is.m0nster.}{
	...
	\usepackage[left=35mm,right=25mm,top=15mm,bottom=20mm]{geometry}
}{
	\newcount\buildnum
	\buildnum=99999
	\let\vref=\ref
...
\section*{Ghi chú của kyanh}
\addcontentsline{toc}{section}{Ghi chú của kyanh}
...
đây. Nếu bạn chỉ có bản |PDF|, bạn có thể xem các hình minh họa ở
\url{http://img.viettug.org/powerdot/}; còn các ví dụ có thể tải về từ
...
\item[tab-slide-contents.png] Trang Mục lục và Bảng Mục lục ở một |slide|
\item[powerdot-default.png] Kiểu trình diễn mặc định
\item[powerdot-simple.png] Kiểu trình diễn |simple|
\item[powerdot-tyjca.png] Kiểu trình diễn |tyjca|
\item[powerdot-ikeda.png] Kiểu trình diễn |ikeda|
\item[powerdot-fyma.png] Kiểu trình diễn |fyma|
\item[powerdot-ciment.png] Kiểu trình diễn |ciment|
\item[exa/]
\item[example-1.tex] Ví dụ đơn giản về \pf{powerdot}.
\end{description}
...
\subsection{Slide tài liệu tham khảo}\label{sec:bib}
...
\section{Biên dịch tạo trình diễn}
\label{sec:compiling}

% =====================================================================

%\subsection{Dependencies}
\subsection{Gói phục thuộc}
...
\subsection{Biên dịch và xem kết quả}
\label{sec:creation}
...
\begin{command}
  ...
  $ ps2pdf foo.ps
\end{command}
(bạn phải biên dịch một, hai hoặc nhiều lần hơn bằng |latex| để các tham khảo chéo được chính xác.)
...
\section{Hỏi-Đáp}\label{sec:questions}

\subsection{Các câu hỏi thường gặp}\label{sec:FAQ}
...
\section{Biên dịch mã nguồn powerdot}
\label{sec:sande}
