...
các |slide| sẽ đánh số tương tự như |5/22| (trang 5, tổng số trang 22).
Chú ý rằng |\arabic{slide}| cho biết trang hiện tại, và |\pageref*{lastslide}|
tổng số |slide|.\footnote{Ta phải dùng |\pageref*|, phiên bản có sao của |pageref|,
...
Xác định hiệu ứng mặc định cho trình diễn.
