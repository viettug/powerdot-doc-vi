...
\author{Hendri Adriaens\and Christopher Ellison
	\\\and \emph{Biên dịch:} kyanh <\url{mailto:kyanh@o2.pl}>}
...
%% |hlentries=false|.
Ở bảng Mục lục, mỗi thành phần sẽ được tô màu nổi bật (|highlight|)
...
được định nghĩa bởi \pf{hyperref} nhở đó ta thu đưọc số trang chứ không phải
...
chân trang (|footer|). Hầu hầu các kiểu trình diễn đều thêm vào bên phải.
