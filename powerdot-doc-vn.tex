...
\def\pdversion{1.3}\def\pddate{2005/11/22}
% =====================================================================

\input pd-preamble-vi
...
\begin{description}
\item[1.3] Cập nhật ngày 22/11/2005.
	\begin{dinglist}{51}
	\item[\ding{53}] Thêm tuỳ chọn |clock|.
	\item[\ding{53}] Thêm hỗ trợ |palette|.
	\item[\ding{53}] Thêm hiệu ứng dấu chấm ngẫu nhiên.
	Xem Mục~\ref{sec:glopts}.
	\item Thêm tuỳ chọn cho lệnh |\maketitle|
	\item Thêm các kiểu: |horatio|, |paintings| và |klope|.
...
dùng riêng cho |slide| đó thôi. Phần tuỳ chọn này bao gồm bất kỳ
tùy chọn nào được nói đến ở Mục~\vref{sec:glopts}.
...
\centerline{\texttt{powerdot-\pdversion-styles-vi.zip}}
...
%% bạn hỗ trợ |UTF-8| (
Tập tin |powerdot-doc-vi.tex| cần hỗ trợ UTF-8 của gói |vntex|.
...
Việc biên dịch tập tin (|powerdot-doc-vi.tex|) để có bản |PDF| như sau:
\begin{command}
  latex powerdot-doc-vi
  latex powerdot-doc-vi
  latex powerdot-doc-vi
  dvips -o powerdot-doc-vi.ps powerdot-doc-vi.dvi
  ps2pdf powerdot-doc-vi.ps
\end{command}
